...
@REM call az keyvault  delete -n vi-dev-kv
@REM call az keyvault  purge -n vi-dev-kv

call az monitor diagnostic-settings delete --name vi-dev-kv-ds --resource "/subscriptions/e669defe-f19a-4012-8e5b-6ac0529e0639/resourceGroups/vi-dev-rg/providers/Microsoft.KeyVault/vaults/vi-dev-kv"
call az monitor diagnostic-settings delete --name vi-dev-vnet-ds --resource "/subscriptions/e669defe-f19a-4012-8e5b-6ac0529e0639/resourceGroups/vi-dev-rg/providers/Microsoft.Network/virtualNetworks/vi-dev-vnet"
